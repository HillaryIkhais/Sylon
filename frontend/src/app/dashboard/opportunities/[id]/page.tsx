...
export default function OpportunityDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex overflow-hidden">
      ...
      <aside className="hidden md:flex w-20 border-r border-white/10 bg-[#0a0a0a] flex-col items-center py-6 relative z-20">
        ...
        <div className="max-w-4xl mx-auto p-4 md:p-10 relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between mb-12 gap-6">
            <div>
              ...
              <p className="text-zinc-400">Morlen is actively building patterns from your conversations.</p>
            </div>
          </div>

          {/* Empty State */}
          <div className="p-12 md:p-24 rounded-3xl bg-zinc-900/30 border border-white/5 flex flex-col items-center text-center justify-center">
