    ...
    <div className="min-h-screen bg-[#050505] text-white flex overflow-hidden">
      ...
      <aside className="hidden lg:flex w-64 border-r border-white/10 bg-[#0a0a0a] flex-col p-4 relative z-20">
        ...
        <nav className="space-y-1">
          ...
          <Link href="/dashboard/opportunities" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/5 text-brand-lightbrown font-medium text-sm border border-brand-lightbrown/10">
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-8 relative z-10">
          ...
          <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-zinc-400">Revenue patterns and churn risks identified by Morlen.</p>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-9 pr-4 py-2 rounded-full bg-zinc-900 border border-white/10 text-sm text-white focus:outline-none focus:border-brand-lightbrown w-full md:w-64"
                />
              </div>
          ...
          {/* Empty State Layout */}
          <div className="p-16 rounded-3xl bg-zinc-900/30 border border-white/5 flex flex-col items-center justify-center text-center mt-12">
