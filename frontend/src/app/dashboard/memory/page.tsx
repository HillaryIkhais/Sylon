    ...
    <div className="min-h-screen bg-[#050505] text-white flex overflow-hidden">
      ...
      <aside className="hidden lg:flex w-64 border-r border-white/10 bg-[#0a0a0a] flex-col p-4 relative z-20">
        ...
        <nav className="space-y-1">
          ...
          <Link href="/dashboard/memory" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/5 text-brand-lightbrown font-medium text-sm border border-brand-lightbrown/10">
