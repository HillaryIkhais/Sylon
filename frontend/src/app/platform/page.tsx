  ...
  return (
    <div ref={containerRef} className="w-full max-w-6xl mx-auto p-4 md:p-8 flex flex-col flex-grow animate-in fade-in duration-500 relative">
      ...
      <header ref={headerRef} className="mb-16 pt-12 text-center max-w-4xl mx-auto">
        ...
        <p className="text-xl text-brand-dark/70 dark:text-white/60 font-medium leading-relaxed px-4">
          Morlen connects to your business data and creates an autonomous intelligence layer that mathematically proves where your revenue is hiding, before you make a decision.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow mb-16">
        ...
        <div ref={el => { cardsRef.current[0] = el; }} className="glass-card rounded-3xl p-10 flex flex-col relative overflow-hidden group border border-brand-dark/10 dark:border-white/10 hover:border-brand-brown/40 transition-all hover:-translate-y-2">
          ...
          <h2 className="text-3xl font-bold text-brand-dark dark:text-white mb-4">Find Hidden Revenue</h2>
          <p className="text-brand-dark/70 dark:text-white/60 leading-relaxed text-lg">
            Stop guessing what your customers want. Morlen uncovers the exact high-value signals hidden inside your daily customer conversations.
          </p>
        </div>
        ...
        <div ref={el => { cardsRef.current[1] = el; }} className="glass-card rounded-3xl p-10 flex flex-col relative overflow-hidden group border border-brand-dark/10 dark:border-white/10 hover:border-brand-brown/40 transition-all hover:-translate-y-2">
          ...
          <h2 className="text-3xl font-bold text-brand-dark dark:text-white mb-4">Topological Orchestration</h2>
          <p className="text-brand-dark/70 dark:text-white/60 leading-relaxed text-lg">
            Automatically find the root cause bottleneck holding back your growth. Morlen mathematically graphs out the optimal path to unlock your revenue.
          </p>
        </div>
        ...
        <div ref={el => { cardsRef.current[2] = el; }} className="glass-card rounded-3xl p-10 flex flex-col relative overflow-hidden group border border-brand-dark/10 dark:border-white/10 hover:border-brand-brown/40 transition-all hover:-translate-y-2">
          ...
          <h2 className="text-3xl font-bold text-brand-dark dark:text-white mb-4">Autopilot Execution</h2>
          <p className="text-brand-dark/70 dark:text-white/60 leading-relaxed text-lg">
            Don't just look at a dashboard. Let Morlen draft the exact resolution path, from supplier emails to dynamic pricing shifts, acting as your autonomous growth engine.
          </p>
        </div>
      </div>
      ...
      <div className="text-center mt-auto pb-12">
        {process.env.NEXT_PUBLIC_SITE_MODE === 'public' ? (
          <button 
            ...
            className="inline-flex text-white bg-gradient-to-r from-brand-lightbrown to-brand-brown hover:opacity-90 px-10 py-5 rounded-full font-bold shadow-xl transition-all items-center space-x-3 hover:scale-105 text-lg"
          >
